...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, int>(
            ...
            (e, c) => ((AGame.Code.Infrastructure.Ecs.Features.Id)c).Value));

        input.AddEntityIndex(new Entitas.PrimaryEntityIndex<InputEntity, int>(
            TouchId,
            input.GetGroup(InputMatcher.TouchId),
            (e, c) => ((AGame.Code.Gameplay.Features.Input.TouchId)c).Value));
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, int>(
            TouchId,
            game.GetGroup(GameMatcher.TouchId),
            (e, c) => ((AGame.Code.Gameplay.Features.Input.TouchId)c).Value));
    }
}
...
public static class ContextsExtensions {
    ...
    public static InputEntity GetEntityWithTouchId(this InputContext context, int Value) {
        return ((Entitas.PrimaryEntityIndex<InputEntity, int>)context.GetEntityIndex(Contexts.TouchId)).GetEntity(Value);
    }

    public static GameEntity GetEntityWithTouchId(this GameContext context, int Value) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, int>)context.GetEntityIndex(Contexts.TouchId)).GetEntity(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
