...
public partial class GameEntity {
    ...
    public AGame.Code.Gameplay.Features.CameraMovement.CameraComponent camera { get { return (AGame.Code.Gameplay.Features.CameraMovement.CameraComponent)GetComponent(GameComponentsLookup.Camera); } }
    ...
    public GameEntity AddCamera(UnityEngine.Camera newValue) {
        ...
        var component = (AGame.Code.Gameplay.Features.CameraMovement.CameraComponent)CreateComponent(index, typeof(AGame.Code.Gameplay.Features.CameraMovement.CameraComponent));
